    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            with transaction.atomic():
                ...
                if not pessoas: # Garante que temos pessoas se o banco já estava vazio
                    self.stdout.write(self.style.ERROR('Erro: Nenhuma pessoa criada. O banco pode estar com conflito de dados.'))
                    return
