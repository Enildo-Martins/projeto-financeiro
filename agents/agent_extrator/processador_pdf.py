# agents/agent_extrator/processador_pdf.py
...
class AgentExtrator:
    """
    Agente responsável por perceber (ler um PDF), processar/interpretar 
    (chamar o Gemini) e decidir (estruturar o JSON).
    """
    def __init__(self):
        """
        Inicializa o agente, configurando a API Key.
        """
    ...
    def executar(self, pdf_stream):
        """
        Executa a ação principal do agente: extrair e interpretar os dados da nota fiscal.
        """
        try:
